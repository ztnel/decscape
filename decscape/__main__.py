...
gpage = os.environ.get('PAGE', 'https://www.mtgtop8.com/archetype?a=9&meta=52&f=ST')
...
buf, deck_count, refs = pull_all(gpage, name=None)
...
_logger.info("side_counts: %s", side_counts)
_logger.info("main_counts: %s", main_counts)
_logger.info("Normalized names: %s", normalized_names)
_logger.info("Normalized side_counts: %s", normalized_side_counts)
_logger.info("Normalized main_counts: %s", normalized_main_counts)
